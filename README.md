Welcome to my portfolio! I am a Senior Technical Consultant specializing in ETL, database development, and data engineering,data analyst with extensive experience across Norway, India, and Singapore. My focus is on designing robust data solutions, optimizing performance, and enabling efficient data-driven decision-making for businesses.

### 👨‍💻 About Me

**Name**: Bithun Kr. Chatterjee
**Location**: Fannrem, Norway
**Languages**: English (Fluent), Norwegian (B1), Hindi (Fluent), Bengali (Fluent)


### 🛠️ **Skills & Expertise**

- **ETL/ELT Development & Automation**: Informatica, Fabrics, ADF, Snowflake, Databricks (SQL, PySpark), Oracle FME
- **Database Design & Modeling:** Oracle SQL/PL-SQL, MSSQL, PostgreSQL, MongoDB
- **Cloud & Data Platforms**: Azure, AWS, Synapse, DBT
- **Data Visualization**: Power BI, Excel
- **Performance Tuning & Optimization** : Advanced SQL, PL/SQL, table partitioning, query optimization
- **DevOps & Collaboration**: GitHub, Azure DevOps
- **Other Tools**: Linux, Shell scripting, PowerShell
...
### 🚀 **Projects**
Here you’ll find a selection of my public projects, code samples, and contributions.
